...
const company_1 = require("../../repository/company");
const transformData_1 = require("../../share/utils/transformData");
class UpdateCompanyUseCase {
    constructor() { }
    execute(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const companyRepository = new company_1.CompanyRepository();
            const transform = new transformData_1.TransformData();
            const newData = yield transform.number(data);
            return yield companyRepository.updateCompany(parseInt(id), newData);
        });
    }
}
